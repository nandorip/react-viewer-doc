...
var Viewer = exports.Viewer = function Viewer(_ref) {
  ...
  var getUnsupportedFileMessage = (0, _react.useCallback)(function () {
    var _labelsRef$current2, _labelsRef$current3;
    return ((_labelsRef$current2 = labelsRef.current) === null || _labelsRef$current2 === void 0 ? void 0 : _labelsRef$current2.unsupportedFile) || ((_labelsRef$current3 = labelsRef.current) === null || _labelsRef$current3 === void 0 ? void 0 : _labelsRef$current3.error) || 'Unsupported file type';
  }, []);
  var setUnsupportedFileError = (0, _react.useCallback)(function () {
    var _onErrorRef$current3;
    var msg = getUnsupportedFileMessage();
    setError(msg);
    (_onErrorRef$current3 = onErrorRef.current) === null || _onErrorRef$current3 === void 0 || _onErrorRef$current3.call(onErrorRef, msg);
  ...
  var showToolbar = Boolean(document) || Boolean(fileSelected);
